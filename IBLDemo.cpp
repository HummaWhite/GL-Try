...
void IBLDemo::resetScreenBuffer(int width, int height)
{
    if (screenFB != nullptr)
    {
        delete screenFB;
...
void IBLDemo::processKey(int key, int scancode, int action, int mode)
{
...
void IBLDemo::processCursor(float posX, float posY)
{
...
void IBLDemo::processScroll(float offsetX, float offsetY)
{
    camera.changeFOV(offsetY);
}

void IBLDemo::processResize(int width, int height)
{
    this->resizeWindow(width, height);
    this->resetScreenBuffer(width, height);
}

void IBLDemo::setupFrameBuffersAndTextures()
{
...
void IBLDemo::setupShaders()
{
    shader = new Shader("res/shader/IBL.shader");
...
void IBLDemo::prefilter()
{
    ...
    int prefMapWidth = 400;
    int prefMapHeight = 200;
...
void IBLDemo::addObject(Model* object, MaterialPBR material)
{
    objects.push_back(object);
    materials.push_back(material);
}

void IBLDemo::removeObject(int objectIndex)
{
...
void IBLDemo::addLight(Light* light)
{
    lights.push_back(light);
}

void IBLDemo::removeLight(int lightIndex)
{
